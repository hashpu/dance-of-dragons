...
const HOUSES = [
  ...
  { slug: "bolton", name: "Bolton", faction: "BLACK FACTION", color: "#a13350",
    tagline: "Our Blades Are Sharp",
    description: "Lords of the Dreadfort in the North, bannermen to House Stark with a grim reputation for flaying their enemies.",
    locked: true, password: "dreadfort", members: [] },
  ...
  { slug: "belaerys", name: "Belaerys", faction: "NEUTRAL", color: "#6a4f8f",
    tagline: "Blood of Old Valyria",
    description: "A minor house whose sphinx sigil is said to guard secrets from a lost age of Valyria.",
    locked: true, password: "oldvalyria", members: [] },
  { slug: "reyne", name: "Reyne", faction: "NEUTRAL", color: "#8f1d1d",
    tagline: "The Rains Remember",
    description: "Lords of Castamere, a wealthy Westerlands house annihilated by Tywin Lannister after the Reyne-Tarbeck Rebellion, remembered in the song \"The Rains of Castamere.\"",
    locked: true, password: "castamere", members: [] },
