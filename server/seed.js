...
const HOUSES = [
  ...
  { slug: "rayne", name: "Rayne", faction: "NEUTRAL", color: "#5a7ba0",
    tagline: "Tears From Above",
    description: "A lesser house of uncertain seat, their banners said to darken like storm clouds before battle.",
    locked: true, password: "raincloud", members: [] },
