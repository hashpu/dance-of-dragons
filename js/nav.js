...
const NAV_ICONS = {
  ...
  rally: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3v18M6 4h12l-3 4 3 4H6"/></svg>`
};
...
(async function () {
  ...
  const links = [
    ...
    { href: "/rally", label: "Rally", icon: "rally" },
